import{d as i,r as m,o as h,c as v,a as t,b as a,w as y,E as d,e as g,f as x,g as f}from"./index-0d50b54c.js";function b(l){if(!navigator.clipboard){let e=document.createElement("textarea");e.value=l,e.style.position="fixed",document.body.appendChild(e),e.select();try{document.execCommand("copy")}catch(s){console.error("无法复制到剪贴板："+s)}document.body.removeChild(e);return}return navigator.clipboard.writeText(l)}const C={class:"page-container"},V={class:"main-content"},E=t("h2",null,"Promise",-1),w=t("h3",null,"copyToClipboard(str: String) 复制文字到剪贴板",-1),B=t("p",null,"返回一个Promise对象。您可以根据监听状态决定复制完后和复制失败后的动作。",-1),T=t("div",{class:"spliter"},null,-1),k=t("h4",null,"试一试",-1),M=t("div",{class:"spliter"},null,-1),N=t("div",{class:"spliter"},null,-1),j=t("div",{class:"spliter"},null,-1),I=`import { ref } from 'vue'
