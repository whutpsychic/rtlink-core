import{r as t,o as c,c as n,a as e,b as s}from"./index-af87bf53.js";const a={class:"page-container"},r={class:"main-content"},l=e("h2",null,"String",-1),m=e("h3",null,"commaedNumber(number: Number) 西化数字显示",-1),_=e("p",null,"返回一个千位用逗号隔开的数字符串。",-1),i=e("p",{class:"result-spliter"},"********************* 运行结果 *********************",-1),u=`import { commaedNumber } from "rtlink-core";
