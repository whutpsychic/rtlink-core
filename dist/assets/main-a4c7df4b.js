import{_ as n,r as l,o as d,c,a as i,p as s,b as p,d as e,t as h}from"./index-66c8d3fa.js";const m={data(){return{code:`import { findTreeParentNodeIdAsCascader } from "rtlink-core";
...
console.log(newData);`,result:"['1623602956200394752', '1623602956896649216', '1623614778093686784']"}}},a=t=>(s("data-v-a168a35b"),t=t(),p(),t),u={class:"page-content-container"},I=a(()=>e("h2",null,h("Array"),-1)),v=a(()=>e("h2",null,"findTreeParentNodeIdAsCascader(data, id, option) 整理树形控制键数据",-1)),_=a(()=>e("h4",null,"data, id, option = { idStr: 'id', childStr: 'children', parentIdStr: 'parentId' }",-1)),T=a(()=>e("p",null,"返回一个经过整理后的一维数组。对比字段，从树形数据中找到目标节点id，并将其各层父节点id按照层级顺序从大到小排进一个数组里，使其可以直接锚定 cascader 中的数据位置。",-1)),f=a(()=>e("p",null," ************** 运行结果 ************** ",-1));function g(t,b,k,V,r,w){const o=l("highlightjs");return d(),c("div",u,[I,v,_,T,i(o,{language:"js",code:r.code},null,8,["code"]),f,i(o,{language:"js",code:r.result},null,8,["code"])])}const z=n(m,[["render",g],["__scopeId","data-v-a168a35b"]]);export{z as default};
